...
Usage:
python3 script_load_predict {expt_name} {output_folder}
...
def main(expt_name,
  ...
  # test = data_formatter.transform_test_data(raw_data, enable_scaling=False)
  _, _, test = data_formatter.split_data(raw_data)
...
if __name__ == "__main__":
  ...
  main(
      ...
      data_csv_path=config.test_data_csv_path,
